...
<head>
    ...
    <title>Pengaduan Keluar</title>
</head>
<body>
    <h2>PENGADUAN KELUAR PER-TANGGAL {{ date('d-m-Y H:i:s') }}</h2>
    <table>
        <thead>
        <tr>
            <th>ID Pengaduan</th>
